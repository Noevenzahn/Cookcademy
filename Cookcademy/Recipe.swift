...
struct Ingredient {
    ...
    //If there are no units, the formattedQuantity and the formattedName are displayed, but no units. The formattedQuantity and formattedName change depending on the quantity of items. If there are units, and the quantity is exactly 1, then the singularName is used. Otherwise, the rawValue of the Unit is used.
    var description: String {
...
// from https://gist.github.com/benstone1/595c00093af3f205973d8a7432204168
extension Recipe {
